...
application.include_router(versions_router,  tags=["Assignment Versions"], prefix="/assignment-verions")
application.include_router(roles_router, tags=["Roles"], prefix="/roles")
application.include_router(student_classes_router, tags=["StudentClasses"], prefix="/student-classes") 
